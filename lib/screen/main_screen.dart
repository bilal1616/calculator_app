              ...
              itemBuilder: (context, index) {
                switch (index) {
                  ...
                  case 18:
                    return CustomAppButton(
                      buttonTapped: () {
                        // ANS düğmesine basıldığında sonuç getirilsin ve ekrana yazılsın
                        String lastResult = controller.getLastResult();
                        controller.userInput +=
                            lastResult; // Sonucu girdiye ekle
                        controller.update(); // Değişiklikleri güncelle
                      },
                      color: themeController.isDark
          ...
          Padding(
            ...
            child: GetBuilder<ThemeController>(builder: (controller) {
              return AdvancedSwitch(
                ...
                inactiveImage: const AssetImage('assets/night_sky.png'),
